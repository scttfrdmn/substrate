...
func esmDoRequest(t *testing.T, ts *emulator.TestServer, method, path, host, contentType string, body io.Reader) *http.Response {
	t.Helper()
...
func esmCreateSQSQueue(t *testing.T, ts *emulator.TestServer, name string) {
	t.Helper()
...
func esmSendSQSMessage(t *testing.T, ts *emulator.TestServer, queueURL, msgBody string) {
	t.Helper()
...
func esmCreateLambdaFunction(t *testing.T, ts *emulator.TestServer, name string) {
	t.Helper()
...
func esmCreateESM(t *testing.T, ts *emulator.TestServer, fnName, eventSourceARN string) string {
	t.Helper()
	payload, _ := json.Marshal(map[string]interface{}{
		"FunctionName":     fnName,
...
func esmDeleteESM(t *testing.T, ts *emulator.TestServer, uuid string) {
	t.Helper()
...
func esmReceiveSQSMessageCount(t *testing.T, ts *emulator.TestServer, queueURL string) int {
	t.Helper()
