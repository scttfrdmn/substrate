...
func setupFirehosePlugin(t *testing.T) (*emulator.FirehosePlugin, *emulator.RequestContext) {
	t.Helper()
...
func firehoseRequest(t *testing.T, op string, body map[string]any) *emulator.AWSRequest {
	t.Helper()
