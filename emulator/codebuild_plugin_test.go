...
func setupCodeBuildPlugin(t *testing.T) (*emulator.CodeBuildPlugin, *emulator.RequestContext) {
	t.Helper()
...
func codebuildRequest(t *testing.T, op string, body map[string]any) *emulator.AWSRequest {
	t.Helper()
