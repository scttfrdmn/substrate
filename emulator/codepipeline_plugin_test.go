...
func setupCodePipelinePlugin(t *testing.T) (*emulator.CodePipelinePlugin, *emulator.RequestContext) {
	t.Helper()
...
func codepipelineRequest(t *testing.T, op string, body map[string]any) *emulator.AWSRequest {
	t.Helper()
