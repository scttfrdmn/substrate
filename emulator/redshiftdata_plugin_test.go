...
func setupRedshiftDataPlugin(t *testing.T) (*emulator.RedshiftDataPlugin, *emulator.RequestContext) {
	t.Helper()
...
func redshiftDataRequest(t *testing.T, op string, body map[string]any) *emulator.AWSRequest {
	t.Helper()
	var b []byte
	if body != nil {
		var err error
