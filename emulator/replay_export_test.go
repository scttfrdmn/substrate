...
func TestGenerateTestFixture_Empty(t *testing.T) {
	src, err := emulator.GenerateTestFixture(nil, "mytestpkg", "TestEmpty")
	if err != nil {
...
func TestGenerateTestFixture_WithEvents(t *testing.T) {
	...
	src, err := emulator.GenerateTestFixture(events, "substrate_test", "TestSQSReplay")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestGenerateTestFixture_BacktickBody(t *testing.T) {
	...
	src, err := emulator.GenerateTestFixture(events, "substrate_test", "TestBacktick")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestGenerateTestFixture_NoBodyEvents(t *testing.T) {
	...
	src, err := emulator.GenerateTestFixture(events, "substrate_test", "TestNoBody")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
