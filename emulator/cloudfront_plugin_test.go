...
func setupCloudFrontPlugin(t *testing.T) (*emulator.CloudFrontPlugin, *emulator.RequestContext) {
	t.Helper()
...
func createTestDistribution(t *testing.T, p *emulator.CloudFrontPlugin, ctx *emulator.RequestContext) string {
	t.Helper()
