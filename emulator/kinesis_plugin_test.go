...
func setupKinesisPlugin(t *testing.T) (*emulator.KinesisPlugin, *emulator.RequestContext) {
	t.Helper()
...
func kinesisRequest(t *testing.T, op string, body map[string]any) *emulator.AWSRequest {
	t.Helper()
