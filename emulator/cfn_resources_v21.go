...
// cfn_resources_v21.go holds the StackDeployer.deployResource helpers for ECR and ECS.
// The name records the substrate release that added them (v0.21.0) rather than the
