...
func setupBackupPlugin(t *testing.T) (*emulator.BackupPlugin, *emulator.RequestContext) {
	t.Helper()
...
func backupRequest(t *testing.T, method, path string, body map[string]any) *emulator.AWSRequest {
	t.Helper()
	var b []byte
	if body != nil {
		var err error
