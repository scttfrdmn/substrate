...
func newEBTestServer(t *testing.T) *emulator.Server {
	t.Helper()
	...
	plugin := &emulator.EventBridgePlugin{}
...
func ebRequest(t *testing.T, srv *emulator.Server, op string, body any) *http.Response {
	t.Helper()
