...
func setupACMPlugin(t *testing.T) (*emulator.ACMPlugin, *emulator.RequestContext) {
	t.Helper()
...
func acmRequest(t *testing.T, op string, body map[string]any) *emulator.AWSRequest {
	t.Helper()
