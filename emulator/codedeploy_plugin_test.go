...
func setupCodeDeployPlugin(t *testing.T) (*emulator.CodeDeployPlugin, *emulator.RequestContext) {
	t.Helper()
...
func codedeployRequest(t *testing.T, op string, body map[string]any) *emulator.AWSRequest {
	t.Helper()
