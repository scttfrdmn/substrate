...
func setupRAMPlugin(t *testing.T) (*emulator.RAMPlugin, *emulator.RequestContext) {
	t.Helper()
...
func ramRequest(t *testing.T, method, path string, body map[string]any) *emulator.AWSRequest {
	t.Helper()
	var b []byte
	if body != nil {
		var err error
