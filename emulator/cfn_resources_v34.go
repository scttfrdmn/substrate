...
// cfn_resources_v34.go holds the StackDeployer.deployResource helpers for
// MSK and RDS (Aurora clusters).
// The name records the substrate release that added them (v0.34.0) rather than the
