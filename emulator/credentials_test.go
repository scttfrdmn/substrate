...
func TestCredentialRegistry_RegisterLookup(t *testing.T) {
	...
	entry := emulator.CredentialEntry{
...
func TestExtractAccessKeyFromAuth(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			got := emulator.ExtractAccessKeyFromAuthForTest(tc.header)
...
func TestBuildCallerARN(t *testing.T) {
	arn := emulator.BuildCallerARNForTest("123456789012", "AKIATEST00000000001")
...
func TestVerifySigV4_NilRegistry(t *testing.T) {
	...
	err := emulator.VerifySigV4ForTest(r, nil, nil)
...
func TestVerifySigV4_NoAuthHeader(t *testing.T) {
	reg := emulator.NewCredentialRegistry()
	r := httptest.NewRequest(http.MethodGet, "/", nil)
	err := emulator.VerifySigV4ForTest(r, nil, reg)
...
func TestVerifySigV4_ValidSignature(t *testing.T) {
	...
	err := emulator.VerifySigV4ForTest(r, body, reg)
