...
func setupAPIGatewayPlugin(t *testing.T) (*emulator.APIGatewayPlugin, *emulator.RequestContext) {
	t.Helper()
...
func apigwRequest(t *testing.T, method, path string, body map[string]any) *emulator.AWSRequest {
	t.Helper()
	var b []byte
	if body != nil {
		var err error
...
func TestAPIGatewayPlugin_CreateResource(t *testing.T) {
	...
	var res emulator.ResourceState
...
func TestAPIGatewayPlugin_CreateDeploymentAndStage(t *testing.T) {
	...
	var dep emulator.DeploymentState
...
func TestAPIGatewayPlugin_DeleteRestApi(t *testing.T) {
	...
	if !ok {
		t.Fatalf("expected *emulator.AWSError, got %T", err)
	}
...
func createTestRestAPI(t *testing.T, p *emulator.APIGatewayPlugin, ctx *emulator.RequestContext, name string) emulator.RestAPIState {
	t.Helper()
