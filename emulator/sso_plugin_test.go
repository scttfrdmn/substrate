...
func setupSSOPlugin(t *testing.T) (*emulator.SSOPlugin, *emulator.RequestContext) {
	t.Helper()
...
func ssoRequest(t *testing.T, op string, body map[string]any) *emulator.AWSRequest {
	t.Helper()
	var b []byte
	if body != nil {
		var err error
