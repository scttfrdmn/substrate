...
func setupTransferPlugin(t *testing.T) (*emulator.TransferPlugin, *emulator.RequestContext) {
	t.Helper()
...
func transferRequest(t *testing.T, op string, body map[string]any) *emulator.AWSRequest {
	t.Helper()
